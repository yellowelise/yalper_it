<?php
function generateSender($length = 20) {
  ...
  <head>
	...
	<link rel="shortcut icon" href="../favicons/favicon.ico">
	  ...
	  <link rel="icon" type="image/png" sizes="16x16" href="../favicons/favicon16.png">
		<link rel="manifest" href="manifest_remoter.json?1fewfew23456" />
...
<div class="container">
	<h2>Evento</h2>
    <input type="text" id="event_push" class="form-control"  onkeyup="this.value = this.value.toUpperCase();" placeholder="Inserisci Evento">
	<hr />
